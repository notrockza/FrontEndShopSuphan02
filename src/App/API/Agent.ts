...
const Account = {
    ...
    delete: (id: number) => requests.post(`Account/DeleteUser?id=${id}`,{}),
    update: (value: any) => requests.post("Account/UpdateAccount", createFormData(value)),
...
const Product = {
    ...
    delete: (id: number) => requests.post(`Product/DeleteProduct?id=${id}`,{}),
    create: (value: any) => requests.post('Product/AddProduct', createFormData (value)),
    update: (value: any) => requests.post("Product/UpdateProduct", createFormData (value)),
};

const ImageProduct = {
    get: (id: any) => requests.get(`ProductDescription/GetDetailAll/${id}`),
    delete: (ID: any) => requests.post(`ProductDescription/DeleteimageDetail?ID=${ID}`,{}),
    create: (values: any) => {
        let formData = new FormData();
...
const Cart = {
    ...
    DeleteCrat: (id: any) => requests.post(`Cart/DeleteCartCustomer?id=${id}`,{}),
    UpdateCrat: (value: any) => requests.post("Cart/UpdateCartCustomer",value),
}
...
const Order = {
    ...
    updateConfirmOrder: (value: any) => requests.post("OrderAccount/ConfirmOrder",createFormData(value) ),
...
const Address = {
    ...
    update: (value: any) => requests.post("address", value),
    updateStatus: (value: any) => requests.put("EditAddressStatus/", value),
    delete: (id: any) => requests.post(`/DeleteAddress?ID=${id}`,{}),
}
...
const Information = {
    ...
    update: (value: any) => requests.post("Information/UpdateInformation", createFormData (value)),
    delete: (id: number) => requests.post(`Information/DeleteInformation?id=${id}`,{}),
};
