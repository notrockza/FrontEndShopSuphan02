...
function CardOrderSucceed() {
 ...
 setId(orderId);
  ...
  return (
    <>
      {ordersSucceed?.map((data) => {
        return (
          <div className="">
            <Card>
              <Ts className="card-header">รายการสั่งซื้อ / สำเร็จเเล้ว </Ts>
              <div className="card-body">
                ...
                <Row justify="start">
                  ...
                  <Col span={4}>
                    {" "}
                    <Tag color="orange">
                      <i className="fa fa-chevron-left"></i> กดทำไมนิ
                    </Tag>
                  </Col>
                </Row>
              </div>
...
export default CardOrderSucceed;
