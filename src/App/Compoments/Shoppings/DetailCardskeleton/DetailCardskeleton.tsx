...
function DetailCardskeleton() {
  ...
  <div className="card-images">
    <div className="blocks pulsate">
    </div>
    <svg className="fpos " width="84px" height="63px" x="50%" y="50%" viewBox="0 0 84 63" version="1.1"  >
  ...
  <div className="card-contents">
    <div className="block2s pulsates">
    </div>
    <div className="block3s pulsates">
    </div>
    <div className="circles pulsates">
    </div>
